...
- Project: IoT & Computer Vision

## 🙏 Acknowledgments

- OpenCV community for computer vision libraries
- ESP32-CAM documentation and tutorials
- Arduino community for hardware support
- Computer vision research papers on parking detection
- Stack Overflow community

## 📞 Support

Having issues? 
- Open an [issue](https://github.com/sasit622/Smart-Parking-Detection/issues)
- Check existing issues and solutions
- Contact via email: [your-email]

## 📈 Project Stats

- **Total Slots Monitored**: 69
- **Detection Methods**: Computer Vision + Sensors
- **Supported Video Formats**: MP4, AVI, MOV
- **Platform**: Windows, Linux, Mac
- **Hardware Cost**: ~$15-25 (ESP32-CAM + components)
...
### **Topics:**
```
smart-parking, computer-vision, opencv, esp32-cam, iot, parking-detection, arduino, real-time-detection, opencv-python, parking-management
